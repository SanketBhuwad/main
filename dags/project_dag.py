...
with DAG('A_Project',
    ...
    insert_product_data = SnowflakeOperator(task_id='insert_product_data',
    ...
    start >> insert_product_data >> insert_customer_data >> insert_order_data >> trigger >> end 
